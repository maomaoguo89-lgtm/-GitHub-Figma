    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <button className="bg-white/10 border border-white/20 text-white text-xs font-bold px-6 py-2.5 rounded-full hover:bg-white/20 transition-all tracking-widest">
            GET STARTED
          </button>
        </div>
      ...
      >
        <div className="px-6 py-8 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4 pt-4 border-t border-white/10">
            ...
            <button className="bg-white/10 border border-white/20 text-white font-bold py-4 rounded-xl hover:bg-white/20 transition-all">GET STARTED</button>
          </div>
        </div>
      </motion.div>
    </nav>
