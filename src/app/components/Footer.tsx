    ...
    <footer className="bg-black border-t border-white/10 py-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-20">
          <div className="col-span-2 lg:col-span-2">
            <a href="/" className="flex items-center gap-2 mb-6">
              <div className="w-8 h-8 bg-white/10 border border-white/20 rounded-sm flex items-center justify-center text-white font-bold text-xl">I</div>
              <span className="font-display font-bold text-xl tracking-tighter">iooi</span>
            </a>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/40">
              ...
              <li><a href="#" className="hover:text-white transition-colors">iooiFlow</a></li>
              <li><a href="#" className="hover:text-white transition-colors">iooiTV</a></li>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-white/20">© 2026 iooi AI Inc. All rights reserved.</p>
