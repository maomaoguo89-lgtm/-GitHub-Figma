  ...
  return (
    <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        >
          iooi is the best way to create with AI. Orchestrate text, image, audio, and video models in one infinite space. Zero friction, infinite possibilities.
        </motion.p>
        ...
        >
          <button 
            onClick={onStart}
            className="group relative bg-white/10 border border-white/20 text-white font-bold px-10 py-4 rounded-full overflow-hidden transition-all hover:bg-white/20 hover:scale-105 active:scale-95"
          >
